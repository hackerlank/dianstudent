...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    JCVideoPlayerStandard pops;
    public void setUp(String url, int screen,String name,Object... objects) {
        if (!TextUtils.isEmpty(this.url) && TextUtils.equals(this.url, url)) {
            return;
        }
        this.url = url;
        this.objects = objects;
        pops=(JCVideoPlayerStandard) objects[0];
...
//                prepareMediaPlayer();
//                pops.dismiss();
                pops.setVisibility(GONE);
                JCUtils.getActivity(getContext()).setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
            }
...
//                startWindowFullscreen();
                JCUtils.getActivity(getContext()).setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                            ...
                            if (absDeltaX > THRESHOLD || absDeltaY > THRESHOLD) {
                                ...
                                if (absDeltaX >= THRESHOLD) {
                                    ...
                                    if (mDownX < mScreenWidth * 0.5f) {//左侧改变亮度
                                        ...
                                        WindowManager.LayoutParams lp = JCUtils.getActivity(getContext()).getWindow().getAttributes();
                    ...
                    if (mChangeBrightness) {
                        ...
                        WindowManager.LayoutParams params = JCUtils.getActivity(getContext()).getWindow().getAttributes();
                        ...
                        JCUtils.getActivity(getContext()).getWindow().setAttributes(params);
                        //dialog中显示百分比
...
//            int duration = getDuration();
        ...
        JCUtils.getActivity(getContext()).setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_SENSOR);
    ...
    public void clearFloatScreen() {
        JCUtils.getActivity(getContext()).setRequestedOrientation(NORMAL_ORIENTATION);
//        showSupportActionBar(getContext());
    ...
    public void autoFullscreen(float x) {
        if (isCurrentJcvd()
            ...
            if (x > 0) {
                JCUtils.getActivity(getContext()).setRequestedOrientation(
...
//            //直接退出全屏和小窗
            ...
            JCMediaManager.instance().releaseMediaPlayer();
            JCVideoPlayerManager.getFirstFloor().setVisibility(GONE);
...
//        hideSupportActionBar(getContext());
        JCUtils.getActivity(getContext()).setRequestedOrientation(FULLSCREEN_ORIENTATION);
...
//    }
    ...
    public static void startFullscreen(Context context, Class _class, String url, Object... objects) {
        ...
        JCUtils.getActivity(context).setRequestedOrientation(FULLSCREEN_ORIENTATION);
...
//        if (ACTION_BAR_EXIST) {
//            ActionBar ab = JCUtils.getActivity(context).getSupportActionBar();
//            if (ab != null) {
...
//        }
        if (TOOL_BAR_EXIST) {
            JCUtils.getActivity(context).getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
...
//        }
        if (TOOL_BAR_EXIST) {
            JCUtils.getActivity(context).getWindow().clearFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
        }
    }
