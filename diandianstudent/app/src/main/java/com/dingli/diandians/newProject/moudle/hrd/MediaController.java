...
public class MediaController extends IjkBaseMediaController {
	...
	private  TextView tvToTime,tvOnlineNumber;
	private LinearLayout bitrateLinearLayout = null,linLandscape,linClose;
	...
	protected void initControllerView(View v) {
		...
		tvOnlineNumber= (TextView) v.findViewById(R.id.tvOnlineNumber);
	...
	public  long mills;
	public  int onLineMan;
	public void setOnLinPosition(long  _mills,int _onLineMan) {
		mills=_mills;
		onLineMan=_onLineMan;
	}
	...
	private long setProgress() {
		...
		mDuration = duration;
		tvOnlineNumber.setText(onLineMan+"");
		if (mEndTime != null)
			mEndTime.setText(generateTime(mDuration));
		if (tvToTime != null)
			mCurrentTime.setText(generateTime(position));
		tvToTime.setText(generateTime(position)+"  直播中");
//		// 获取播放器稳定的时间后再seekTo
//		if (mDanmakuView != null)
	...
	private static String getOnlinTime(long totalSeconds) {
