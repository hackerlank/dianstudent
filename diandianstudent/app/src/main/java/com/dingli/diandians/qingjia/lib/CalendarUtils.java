...
public class CalendarUtils {
	...
	static {
		dayOfMonth = Calendar.getInstance().get(Calendar.DAY_OF_MONTH)-3;
...
//		try{
//			 date=formatter.parse(orderDay);
//		}catch (Exception e){
//            e.printStackTrace();
//		}
//		calendar .setTime(date);
//		Calendar month = (Calendar) calendar.clone();
//		lastDay= gCalendar.getActualMaximum(GregorianCalendar.DAY_OF_MONTH);
//		firstDay=gCalendar.get(Calendar.DAY_OF_WEEK);
//		int lastDay = month.getActualMaximum(Calendar.DAY_OF_MONTH);
//			int firstDay = (int) month.get(Calendar.DAY_OF_WEEK);
//		if(Integer.parseInt(orderInfo[1])!=monthe){
//			int lastDay = month.getActualMaximum(Calendar.DAY_OF_MONTH);
//			int firstDay = (int) month.get(Calendar.DAY_OF_WEEK);
//		}else{
			month.set(Calendar.DAY_OF_MONTH, 1);
