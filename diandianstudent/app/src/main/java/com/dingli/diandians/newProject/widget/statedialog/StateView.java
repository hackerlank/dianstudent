    ...
    private void initStatePath() {
        ...
        switch (mState) {
            ...
            case FAILUE:
                ...
                mStateOnePath.moveTo(percentage.get(35)[0], percentage.get(35)[1]);
                mStateOnePath.lineTo(percentage.get(85)[0], percentage.get(85)[1]);
                mStateTwoPath.moveTo(percentage.get(10)[0], percentage.get(10)[1]);
                mStateTwoPath.lineTo(percentage.get(60)[0], percentage.get(60)[1]);
