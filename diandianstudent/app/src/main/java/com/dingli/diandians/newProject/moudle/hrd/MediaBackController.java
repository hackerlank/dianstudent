...
public class MediaBackController extends IjkBaseMediaController {
...
//	private ImageButton mPreButton;
	...
	public MediaBackController(Context context, AttributeSet attrs) {
		super(context, attrs);
		mRoot = this;
		mFromXml = true;
	 ...
	 * @param isUsePreNext
	 */
	public MediaBackController(Context context, boolean isUsePreNext) {
		super(context);
	...
	protected View makeControllerView() {
		mRoot = ((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE))
				.inflate(R.layout.ijkmedia_back_controller, this);
		return mRoot;
	}
	...
	protected void initControllerView(View v) {
		...
		linLandscape = (LinearLayout) v.findViewById(R.id.linLandscape);
		linLandscape.setOnClickListener(mBoardListener);

		linClose= (LinearLayout) v.findViewById(R.id.linClose);
		linClose.setOnClickListener(closeListener);
		...
		bitrateLinearLayout = (RelativeLayout) mRoot.findViewById(R.id.bitrate_linear_layout);
	...
	private OnClickListener closeListener = new OnClickListener() {
		...
		public void onClick(View v) {
			EventBus.getDefault().post("", BKConstant.EventBus.HRDCLOSE);
		}
	};
...
//		if (mDanmakuView != null)
	...
	private void updatePausePlay() {
		...
		if (mPlayer.isPlaying()) {
			if(isScreenPortrait()){
				mPauseButton.setImageResource(R.mipmap.icon_pause);
			}else {
				mPauseButton.setImageResource(R.mipmap.icon_stop_big);
			}

		} else {
			if(isScreenPortrait()){
				mPauseButton.setImageResource(R.mipmap.icon_start);
			}else {
				mPauseButton.setImageResource(R.mipmap.icon_start_big);
			}
