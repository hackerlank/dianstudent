...
public class WebViewLianxisActivity extends Activity implements View.OnClickListener{
    ...
    private void initView() {
        ...
        TextView tvlianxi=(TextView) findViewById(R.id.tvlianxi);
        tvlianxi.setText("选择课程");
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.lianxibacks:
                WebViewLianxisActivity.this.finish();
